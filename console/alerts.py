...
def render_example_ini():
    lines = [
        ...
        "; Either way the FIRST message is a \"starting point\": it says how many alerts",
        "; are open and names the most serious few, rather than reporting every one of",
        "; them as news. After that you only hear about what changes.",
        "when = changes",
        ...
        "; \"Send webhook alerts to a channel\" > pick this team and channel > copy",
        "; the URL it gives you. (Microsoft has also called that template \"Post to a",
        "; channel when a webhook request is received\" - same thing, and searching",
        "; for the old name finds nothing.)",
